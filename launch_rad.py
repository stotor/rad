...
params['save_folder'] = field_folder + '/point_source/'
# Proton source properties
params['u_mag'] = 0.177707
params['rqm'] = 1836.0
params['proton_yield'] = 10**9
# Simulation plasma properties
params['dx'] = 2.0
params['dt'] = 1.14
params['mi_mez_sim'] = 128.0
params['b1_filename'] = field_folder + '/b1-savg-' + str(t).zfill(6) + '.h5'
params['b2_filename'] = field_folder + '/b2-savg-' + str(t).zfill(6) + '.h5'
params['b3_filename'] = field_folder + '/b3-savg-' + str(t).zfill(6) + '.h5'
